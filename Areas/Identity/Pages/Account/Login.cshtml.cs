    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                bool hasRole = await _userManager.IsInRoleAsync(user, "Contributor") || await _userManager.IsInRoleAsync(user, "Admin");
                if (!hasRole)
                {
                    return RedirectToPage("./WaitingForConfirmation");
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        _logger.LogInformation("Contributor logged in.");
